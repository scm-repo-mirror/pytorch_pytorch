  ...
  [record function] FWD
    ...
    def test_invoke_subgraph(self):
        ...
        self.assertExpectedInline(
            debug_mode.debug_string(),
            """\
    torch.ops.higher_order.invoke_subgraph(GraphModule(GraphModule), partitioned_fw_subgraph_0_0, t: f32[8, 8])  ->  ('t: f32[8, 8]', 't: f32[8, 8]')
    ...
    torch.ops.higher_order.invoke_subgraph(GraphModule(GraphModule), partitioned_bw_subgraph_0_0, t: f32[8, 8], t: f32[8, 8])  ->  ('t: f32[8, 8]',)
    ...
    def test_nested_invoke_subgraph(self):
        ...
        self.assertExpectedInline(
            debug_mode.debug_string(),
            """\
    torch.ops.higher_order.invoke_subgraph(GraphModule(<lambda>), subgraph_1, t: f32[8, 8])  ->  ('t: f32[8, 8]',)
    [annotate] [enter InvokeSubgraph HOP] subgraph_1
    aten::add.Tensor(t: f32[8, 8], 1)  ->  t: f32[8, 8]
    torch.ops.higher_order.invoke_subgraph(GraphModule(<lambda>), subgraph_0, t: f32[8, 8])  ->  ('t: f32[8, 8]',)
